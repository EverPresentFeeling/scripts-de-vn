...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("Automatic saves"), quick=_("Guardados rápidos"))
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("espacio vacío")):
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Pantalla")
                        textbutton _("Modo ventana") action Preference("display", "window")
                ...
                vbox:
                    ...
                    textbutton _("Derecha") action Preference("rollback side", "left")
                    textbutton _("Izquierda") action Preference("rollback side", "right")

                vbox:
                    style_prefix "check"
                    label _("Saltar")
                    textbutton _("Partes no leídas") action Preference("skip", "toggle")
                    textbutton _("Después de una decisión") action Preference("after choices", "toggle")
                    textbutton _("Entre escenas") action InvertSelected(Preference("transitions", "toggle"))
